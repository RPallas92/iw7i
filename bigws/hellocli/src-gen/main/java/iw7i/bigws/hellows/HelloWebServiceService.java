 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceService", targetNamespace = "http://hellows.bigws.iw7i/", wsdlLocation = "http://localhost:8080/hellows/helloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICESERVICE_QNAME = new QName("http://hellows.bigws.iw7i/", "HelloWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/hellows/helloWorld?wsdl");
    ...
    public HelloWebService getHelloWebServicePort() {
        return super.getPort(new QName("http://hellows.bigws.iw7i/", "HelloWebServicePort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hellows.bigws.iw7i/", "HelloWebServicePort"), HelloWebService.class, features);
    }
